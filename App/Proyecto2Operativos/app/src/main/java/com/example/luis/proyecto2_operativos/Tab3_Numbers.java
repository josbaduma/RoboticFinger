...
public class Tab3_Numbers extends Fragment{
    private static final String TAG = "Tab3_Numbers";
    TextView pin_number;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab3_numbers, container, false);
